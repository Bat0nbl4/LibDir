<header class="p-3 mb-3 border-bottom">
    <div class="container">
        <div class="d-flex flex-md-column flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-md-auto me-md-auto mb-2 justify-content-center align-items-md-center mb-lg-0">
