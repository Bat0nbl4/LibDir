<form method="POST" action="<?php echo \core\routing\Router::route("admin.book.store") ?>" enctype="multipart/form-data">
    <p>
            ...
            <div class="d-flex flex-row gap-2">
                <select class="form-control" name="author_id" id="author_id">
                    ...
                    <?php foreach ($authors as $author): ?>
                        <option value="<?php echo $author["id"] ?>"><?php echo $author["surname"]." ".$author["name"]." ".$author["patronymic"] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
    ...
    <div class="row mb-3">
        <div class="col-12 mb-3">
            ...
            <input class="form-control" type="text" id="title" name="title" value="<?php echo \core\session\Session::getFlash("old_input.title"); ?>" required>
        ...
        <div class="col-4 mb-3">
            ...
            <input class="form-control" type="number" id="pages_count" name="pages_count" value="<?php echo \core\session\Session::getFlash("old_input.pages_count") ?? 0; ?>" required>
        ...
        <div class="col-4 mb-3">
            ...
            <input class="form-control" type="number" id="count" name="count" value="<?php echo \core\session\Session::getFlash("old_input.count") ?? 0; ?>" required>
            <span class="text-danger"><?php echo \core\session\Session::getFlash("input_errors.count") ?? ""; ?></span>
        </div>
        <div class="col-4 mb-3">
            <label class="form-label" for="price">Цена</label>
            <input class="form-control" type="number" id="price" name="price" value="<?php echo \core\session\Session::getFlash("old_input.price") ?? 0; ?>" required>
            <span class="text-danger"><?php echo \core\session\Session::getFlash("input_errors.price") ?? ""; ?></span>
        </div>
        <div class="col-12 d-flex flex-column">
            <label class="form-label" for="description">Описание</label>
            <textarea rows="10" class="form-control" type="text" id="description" name="description"><?php echo \core\session\Session::getFlash("old_input.description"); ?></textarea>
